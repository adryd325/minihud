...
public enum RendererToggle implements IHotkeyTogglable, IConfigNotifiable<IConfigBoolean>
{
    ...
    DEBUG_STRUCTURE                     ("debugStructureEnabled",       "", "Toggles the vanilla Structure debug renderer", "Structure"),
    DEBUG_VILLAGE                       ("debugVillageEnabled",         "", "Toggles the vanilla Village debug renderer", "Village"),
    DEBUG_VILLAGE_SECTIONS              ("debugVillageSectionsEnabled", "", "Toggles the vanilla Village sections debug renderer", "Village Sections"),
    DEBUG_GOAL_SELECTOR                 ("debugGoalSelectorEnabled",    "", "Toggles the vanilla Goal selector debug renderer", "Goal selector"),
    DEBUG_GAME_EVENT                    ("debugGameEventEnabled",       "", "Toggles the vanilla Game event debug renderer", "Game event"),
    DEBUG_BEES                          ("debugBeesEnabled",            "", "Toggles the vanilla Bees debug renderer", "Bees"),
    DEBUG_HEIGHTMAP                     ("debugHeightmapEnabled",       "", "Toggles the vanilla Heightmap debug renderer", "Height map"),
    DEBUG_SKYLIGHT                      ("debugSkylightEnabled",        "", "Toggles the vanilla Skylight debug renderer", "Skylight"),
    DEBUG_WORLD_GEN                     ("debugWorldGenEnabled",        "", "Toggles the vanilla World gen debug renderer", "World Gen"),
    DEBUG_CHUNK_LOADING                 ("debugChunkLoadingEnabled",    "", "Toggles the vanilla Chunk loading debug renderer", "Chunk Loading"),
    DEBUG_RAID                          ("debugRaidEnabled",            "", "Toggles the vanilla Raid debug renderer", "Raid"),
